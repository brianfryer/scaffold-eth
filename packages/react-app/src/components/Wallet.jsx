...
const Wallet = ({
  ...
  if (qr) {
    ...
    if (wallet.address !== selectedAddress) {
      display = (
        <div>
          <strong>*injected account*, private key unknown</strong>
        </div>
      );
    } else {
  ...
  return (
    <span>
      ...
      <Modal
        ...
        title={(
          <div>
            {!selectedAddress ? <Spin /> : (
              <Address address={selectedAddress} ensProvider={ensProvider} />
            )}
          ...
          <Button
            ...
            onClick={() => {
              ...
              try {
                ...
                value = parseEther(String(parseFloat(amount).toFixed(8)));
              }
