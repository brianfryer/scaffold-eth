...
/*
  ...
  Enables you to read values from contracts and keep track of
  them in the local React states
  ...
  - Specify the name of the variable in the contract, in this case we
    keep track of 'purpose' variable
  - Pass an args array if the function requires
  - Pass pollTime - if no pollTime is specified, the function will
    update on every new block
*/
...
const useContractReader = (
  ...
  useOnBlock(
    (contracts && contracts[contractName] && adjustPollTime === 0)
